		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-3">
					...
					<p class="phone-no">
						<i class="anm anm-phone-s"></i> +8400000000
					</p>
				</div>
		...
		<div class="container-fluid">
			<div class="row align-items-center">
				...
				<div class="logo col-md-2 col-lg-2 d-none d-lg-block">
					<a style="text-decoration: none;" href="/"><h1 style="font-size:20px; font-weight: 600; color: rgb(39, 39, 39);	">MeowsHome</h1> </a>
				...
				<div class="col-2 col-sm-3 col-md-3 col-lg-8">
					...
					<nav class="grid__item" id="AccessibleNav">
						...
						<ul id="siteNav" class="site-nav medium right hidearrow">
							...
							<li class="lvl1"><a href="/order/checkout"><b>Buy Now!</b> <i
									class="anm anm-angle-down-l"></i></a></li>
						</ul>
					</nav>
					<!--End Desktop Menu-->
