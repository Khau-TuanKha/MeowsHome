					...
					<div class="col-12 col-sm-12 col-md-3 col-lg-3 sidebar filterbar">
						...
						<div class="sidebar_tags">
							...
							<div class="sidebar_widget filterBox filter-widget">
								...
								<form action="">
									<button formaction="/product/list/price/under500"
										class="btn mb-2 btn--secondary">Dưới 500K</button>
									<button formaction="/product/list/price/500-300000"
										class="btn mb-2 btn--secondary">Từ 500K - 3000K</button>
									<button formaction="/product/list/price/300000-600000"
										class="btn mb-2 btn--secondary">Từ 3000K - 6000K</button>
									<button formaction="/product/list/price/over600000"
										class="btn mb-2 btn--secondary">Trên 6000K</button>
								</form>
							</div>
							<!--End Price Filter-->
